...
export const metadata = {
  title: 'Productos Amazon | KINEXIS',
  description: 'Catálogo de productos en Amazon',
}
    ...
    <div className="space-y-6">
      ...
      <Suspense fallback={<PageSkeleton />}>
        <div className="glassmorphism p-12 flex flex-col items-center text-center gap-4">
          ...
          <h3 className="text-lg font-semibold text-white/80">Catálogo Amazon en desarrollo</h3>
          <p className="text-sm text-white/40 max-w-md">
            Sincronización de listings Amazon MWS disponible en Fase 2.
          </p>
        </div>
      </Suspense>
    </div>
