...
const PLANS = [
  {
    ...
    features: ['1 Módulo a elegir', '500 Conversaciones Samantha', '100 Timbres CFDI', '3 Usuarios', 'Margen Bruto: 47%'],
    cta: 'Comenzar ahora', featured: false,
  },
  {
    name: 'Growth', price: '$10,500 MXN', period: 'mes',
    desc: 'Para negocios en expansión',
    features: ['2 Módulos a elegir', '750 Conversaciones Samantha', '150 Timbres CFDI', '5 Usuarios', 'Margen Bruto: 55%'],
    cta: 'Solicitar demo', featured: true,
  },
  {
    name: 'Pro', price: '$16,500 MXN', period: 'mes',
    desc: 'Para grandes operaciones',
    features: ['3 Módulos (Suite Completa)', '1,000 Conversaciones Samantha', '200 Timbres CFDI', 'Usuarios Ilimitados', 'Margen Bruto: 60%'],
