        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-white/90 font-bold uppercase tracking-widest flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse"></span> En línea
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-800 bg-gray-900 shrink-0">
        <div className="relative flex items-center">
          <input
            ...
            className="w-full bg-gray-800 border border-gray-700 text-white text-sm rounded-xl pl-4 pr-10 py-3 focus:outline-none focus:border-green-500/50 focus:bg-gray-800 transition-colors"
          />
          <button
            onClick={handleSend}
