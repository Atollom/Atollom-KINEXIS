    ...
    >
      ...
      <div className="px-8 pt-10 pb-8">
        <Link href="/" className="flex flex-col gap-1 group">
          <h1 className="text-2xl font-black tracking-[-0.05em] text-[#ccff00] leading-none mb-1">
            KINEXIS
          </h1>
      ...
      {/* Decoration */}
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-[#ccff00]/5 to-transparent pointer-events-none" />
    </aside>
  );
}
